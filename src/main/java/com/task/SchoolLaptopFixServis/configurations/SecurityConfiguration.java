package com.task.SchoolLaptopFixServis.configurations;
import com.task.SchoolLaptopFixServis.utilities.RSAKeyProperties;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(auth -> {
                    auth.requestMatchers("laptopServisApi/auth/**").permitAll();
